...
public class ActivityInsertPhoneNumber extends AppCompatActivity {
    EditText edtNhapSDT;
        ...
        btnTieptucSDT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edtNhapSDT.getText().length() != 0){
                    Intent intent = new Intent(ActivityInsertPhoneNumber.this, ActivityInsertOTPNewPass.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(ActivityInsertPhoneNumber.this, "Bạn chưa nhập số điện thoại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
