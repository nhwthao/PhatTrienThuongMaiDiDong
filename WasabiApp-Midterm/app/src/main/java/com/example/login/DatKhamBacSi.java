...
public class DatKhamBacSi extends AppCompatActivity {
    ListView lvDoctor2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dat_kham_bac_si);
        linkViews();
        initData();
        loadData();
    }
    ...
    private void loadData() {
        doctorAdapter=new DoctorAdapter(DatKhamBacSi.this,R.layout.item_doctor,doctors);
