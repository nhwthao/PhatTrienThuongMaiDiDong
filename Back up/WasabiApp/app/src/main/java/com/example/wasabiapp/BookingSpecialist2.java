...
public class BookingSpecialist2 extends AppCompatActivity {
    ListView lvDoctor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_specialist2);
        linkViews();
        initData();
        loadData();
        addEvents();
    ...
    private void loadData() {
        doctorAdapter=new DoctorAdapter(BookingSpecialist2.this,R.layout.item_doctor,doctors);
...
//                }
                ...
                Intent intent = new Intent(BookingSpecialist2.this, BookingSpecialist3.class);
